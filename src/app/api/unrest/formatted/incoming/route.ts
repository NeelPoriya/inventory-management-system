...
export async function GET(request: NextRequest) {
  try {
    ...
    const items = await Incoming.aggregate([
      {
        $match: {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(chalk.blue("badgeIds: "), badgeIds);
    console.log(chalk.blue("clientIds: "), clientIds);
    console.log(chalk.blue("productVariantIds: "), productVariantIds);
